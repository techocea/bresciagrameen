    ...
    <section className="bg-dark-gray max-md:p-10 lg:px-16 lg:py-14 h-auto">
      ...
      <div className="text-white flex flex-col gap-5 lg:gap-8 pt-16 lg:pt-24">
        <p className="font-regular lg:text-[20px]">
          ...
          customers in Negombo to save and enjoy exclusive benefits. As a B-Mart
          Loyalty Cardholder, you can earn points with every purchase at our
          supermarket, which you can redeem for fantastic rewards.
        </p>
        <p className="font-regular lg:text-[20px]">
        ...
        <p className="font-regular lg:text-[20px]">
          Join the B-Mart Loyalty Program today and start enjoying the perks of
          being a loyal customer. Experience more savings, more convenience, and
          more rewards, exclusively at B-Mart!
        </p>
      </div>
    </section>
  );
